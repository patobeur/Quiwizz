const profile = (() => {
    ...
    function init() {
        ...
        document.getElementById('cancel-edit-profile-btn').addEventListener('click', hideEditForm);
        ...
        window.addEventListener('hashchange', () => {
            if (window.location.hash === '#profile' || window.location.hash === '#badges') {
    ...
    async function loadProfileAndBadgesData() {
        ...
        try {
            ...
            console.error('Erreur lors du chargement des données du profil/badges', error);
    ...
    function renderProfile(data) {
        ...
        document.getElementById('profile-firstname').textContent = data.first_name || 'Non renseigné';
        document.getElementById('profile-lastname').textContent = data.last_name || 'Non renseigné';

        // Pré-remplir le formulaire d'édition
        document.getElementById('profile-edit-pseudo').value = data.pseudo || '';
        document.getElementById('profile-edit-firstname').value = data.first_name || '';
        document.getElementById('profile-edit-lastname').value = data.last_name || '';
    }
